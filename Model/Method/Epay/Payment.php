...
class Payment extends \Duitku\Jeniuspay\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_jeniuspayepay';
    const METHOD_REFERENCE = 'duitkujeniuspayReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Jeniuspay\Block\Info\View';
    ...
    /**
     * @var \Duitku\Jeniuspay\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Jeniuspay\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Jeniuspay\Model\Api\Epay\Request\Payment
     */
     ...
     * @return \Duitku\Jeniuspay\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayjeniuspay/cancel', ['_secure' => $this->_request->isSecure()]);
    }
