<?php
/**
 * Copyright (c) 2017. All rights reserved Duitku Jeniuspaypayment.
 *
 ...
 *
 * @author    Duitku Jeniuspaypayment
 * @copyright Duitku Jeniuspaypayment (http://duitku.com)
 * @license   Duitku Jeniuspaypayment
 *
 */
namespace Duitku\Jeniuspay\Block\Adminhtml\Sales\Order\View;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\Jeniuspay\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\Jeniuspay\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Jeniuspay\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
