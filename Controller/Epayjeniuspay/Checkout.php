...
class Checkout extends \Duitku\Jeniuspay\Controller\AbstractActionController
{
    /**
     * Checkout Action
     */
    public function execute()
    {
    	 ...
    	 $paymentmode = $this->_scopeConfig->getValue('payment/duitku_jeniuspayepay/payment_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    	 if($paymentmode =='1')
    	 {
        ...
        $result = $this->getEPayPaymentWindowRequest($order);
       	$helper = $obj->get('Duitku\Jeniuspay\Helper\Data');
