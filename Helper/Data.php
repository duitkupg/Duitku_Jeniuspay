...
namespace Duitku\Jeniuspay\Helper;
include_once('Duitku/DuitkuCore.php');
use Duitku\Jeniuspay\Helper\DuitkuConstants;
use Duitku_Jeniuspay_Core;
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * @var \Duitku\Jeniuspay\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\Jeniuspay\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Jeniuspay\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_jeniuspayepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Jeniuspay_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Jeniuspay")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Jeniuspay\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
